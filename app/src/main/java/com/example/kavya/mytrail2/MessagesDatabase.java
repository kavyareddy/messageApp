...
//        DB_VERSION = i;
    ...
    public void insert(String msgBody, String msgStatus, String msgType){
...
//            db.execSQL(sql1);
            String sql = String.format("CREATE TABLE %s( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s text, %s text, %s text);", TABLE_NAME,C_id, C_MSGS, C_STATUS, C_MSGTYPE);
